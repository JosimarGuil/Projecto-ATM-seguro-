    ...
    <div class="mt-16 flex grid grid-cols-5 gap-8 justify-between">
        ...
        <div class="avatar flex justify-between  py-4">
            ...
            <ul>
                ...
                <li><b>Endereço: </b>{{$atm->countrie->name.'-'.$atm->state->name.'-'.$atm->bairro}}</li>
            </ul>
        </div>
         <div class=" shadow">
                <div class="stat">
                    ...
                    <div class="mt-8 border ">
                        <button class="btn btn-outline btn-success mt-8/ text-white font-semibold">Success</button>
                    </div>
                </div>
            </div>
...
<!--DIGITOS--->
        <div class=" border border-gray-600  grid col-span-2 rounded-lg px-20 py-8">
            ...
            <br>
            <div class="flex gap-4 grid grid-cols-4 container mx-auto  py-8">
                @for($i=0;$i<=9;$i++)
                    <button class="btn btn-primary text-white rounded-xl font-semibold">{{$i}}</button>
                @endfor
